    ...
    return (
      <AnimatePresence>
        <motion.div
          ...
          exit={{ opacity: 0, y: -50 }}
          className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border-b border-yellow-500/20 backdrop-blur-sm relative z-[40]"
        >
    ...
    return (
      <AnimatePresence>
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          exit={{ opacity: 0, y: -50 }}
          className="bg-gradient-to-r from-purple-900/50 to-violet-900/50 border-b border-purple-500/30 backdrop-blur-sm relative z-[40]"
        >
